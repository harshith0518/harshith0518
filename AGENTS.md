...
- Experience cards preserve the original index-based panel colors, card numbers, diagrams, and field-note footer. The employer name is the first linked heading, the work headline follows it, and the description remains secondary. Keep company-specific decoration out unless the user explicitly requests it again.
...
3. Scroll through every sticky experience card, verify each company-heading link and the original card treatment, then test the independent project and ranks block directly below it.
